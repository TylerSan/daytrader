...
from daytrader.cli.journal_cmd import pre_trade, post_trade, circuit_group, sanity_group, dry_run_group, resume_gate_group, audit_cmd, review_history_cmd  # noqa: E402
...
journal.add_command(review_history_cmd)
